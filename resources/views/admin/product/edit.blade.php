     ...
     <form action="{{ route('admin.product.update', $productos->id) }}" method="POST">
           @csrf    
           @method('PUT')
      <!-- Default box -->
      ...
      <div class="card">
        ...
        <div class="card-body">
                <div class="form-group">                    
                    ...
                    <textarea class="form-control" name="descripcion" id="descripcion" cols="30" row="5">{{ old('descripcion',$productos->descripcion) }}</textarea>
                </div>
